...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram(
			"Shader/Chapter12/Program5/vertShader.glsl", "Shader/Chapter12/Program5/tessCShader.glsl",
			"Shader/Chapter12/Program5/tessEShader.glsl", "Shader/Chapter12/Program5/fragShader.glsl");
	...
	squareMoonTexture = Utils::loadTexture("Assets/Textures/Chapter12/squareMoonMap.jpg");
	squareMoonHeight = Utils::loadTexture("Assets/Textures/Chapter12/squareMoonBump.jpg");
	squareMoonNormals = Utils::loadTexture("Assets/Textures/Chapter12/squareMoonNormal.jpg");
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "Chapter 12 - program 5", NULL, NULL);
