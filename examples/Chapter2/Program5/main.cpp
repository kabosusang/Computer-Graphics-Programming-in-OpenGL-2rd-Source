...
GLuint createShaderProgram() {
	...
	string vertShaderStr = readShaderSource("Shader/Chapter2-Program5/vertShader.glsl");
	string fragShaderStr = readShaderSource("Shader/Chapter2-Program5/fragShader.glsl");
