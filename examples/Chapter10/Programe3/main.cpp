...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram(
        "Shader/Chapter10/Program3/BlinnPhongShadersNormal/vertShader.glsl", 
        "Shader/Chapter10/Program3/BlinnPhongShadersNormal/fragShader.glsl");
	...
	moonTexture = Utils::loadTextureMipMapAnisotropic(
        "Assets/Textures/Chapter10/moon.jpg");
	moonNormalMap = Utils::loadTextureMipMapAnisotropic(
        "Assets/Textures/Chapter10/moonNORMAL.jpg");
}
