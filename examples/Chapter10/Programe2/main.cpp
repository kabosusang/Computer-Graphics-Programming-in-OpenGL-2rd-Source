...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram(
        "Shader/Chapter10/BlinnPhongShadersNormal/vertShader.glsl", 
        "Shader/Chapter10/BlinnPhongShadersNormal/fragShader.glsl");
	...
	roofTexture = Utils::loadTexture(
        "Assets/Textures/Chapter10/castleroofNORMAL.jpg");
}
