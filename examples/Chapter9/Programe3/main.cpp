...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram(
        "Shader/Chapter9/Program3/vertShader.glsl", 
        "Shader/Chapter9/Program3/fragShader.glsl");
	renderingProgramCubeMap = Utils::createShaderProgram(
        "Shader/Chapter9/Program3/vertShaderCubeMap.glsl", 
        "Shader/Chapter9/Program3/fragShaderCubeMap.glsl");
	...
	skyboxTexture = Utils::loadCubeMap("Assets/Textures/Chapter9/cubeMap"); // expects a folder name
